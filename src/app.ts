...
cloudinary.config({ 
  cloud_name: process.env.CLOUDINARY_CLOUD_NAME || 'dmpratgsn', 
  api_key: process.env.CLOUDINARY_API_KEY || '952419299651983', 
  api_secret: process.env.CLOUDINARY_API_SECRET || '6-OGcVWNDnFWkxc3_v9r9f3L6wY'
})
